...
class PikaBinlogParser {
 public:
   ...
   */
  pink::ReadStatus ScrubReadBuffer(const char* rbuf, int len, int* processed_len, int* scrubed_len, BinlogHeader* binlog_header, PortBinlogItem* binlog_item);
 ...
 private:
  pink::ReadStatus BinlogParseHeader(const char* rbuf, int len, int* processed_len, int* scrubed_len, BinlogHeader* binlog_header, PortBinlogItem* binlog_item);

  pink::ReadStatus BinlogParseDecode(const char* rbuf, int len, int* processed_len, int* scrubed_len, BinlogHeader* binlog_header, PortBinlogItem* binlog_item);

  pink::ReadStatus BinlogParseContent(const char* rbuf, int len, int* processed_len, int* scrubed_len, BinlogHeader* binlog_header, PortBinlogItem* binlog_item);
